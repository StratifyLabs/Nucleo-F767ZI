...
#define SOS_BOARD_SPI1_RX_DMA 0
#define SOS_BOARD_SPI1_RX_DMA_STREAM 0
#define SOS_BOARD_SPI1_RX_DMA_CHANNEL 0
#define SOS_BOARD_SPI1_TX_DMA 0
#define SOS_BOARD_SPI1_TX_DMA_STREAM 0
#define SOS_BOARD_SPI1_TX_DMA_CHANNEL 0
...
#define SOS_BOARD_SPI3_RX_DMA 0
#define SOS_BOARD_SPI3_RX_DMA_STREAM 0
#define SOS_BOARD_SPI3_RX_DMA_CHANNEL 0
#define SOS_BOARD_SPI3_TX_DMA 0
#define SOS_BOARD_SPI3_TX_DMA_STREAM 0
